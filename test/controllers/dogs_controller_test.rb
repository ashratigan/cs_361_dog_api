...
class DogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog" do
    assert_difference("Dog.count") do
      post dogs_url, params: { dog: { country: @dog.country, image: @dog.image, name: @dog.name, pdf: @dog.pdf, url: @dog.url } }
    end
  ...
  test "should update dog" do
    patch dog_url(@dog), params: { dog: { country: @dog.country, image: @dog.image, name: @dog.name, pdf: @dog.pdf, url: @dog.url } }
